...
<head>
    ...
    <title>Download App - Gwalior CovidFree </title>
...
<div class="container">
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-4">
        <h4>Download CovidFree App</h4>

        <img style="height:90px;" src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png">
        <br><small class="">Coming Soon</small>
    ...
    <div class="col-md-7">
      ...
      <div class="card" >
        ...
        <li class="list-group-item">Download the Store App for update status in real time</li>
      </ul>
      </div>
